defmodule TemplateCoffeeWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: TemplateCoffeeWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import TemplateCoffeeWeb.CoreComponents
      ...
      import TemplateCoffeeWeb.ColocatedScopedCSS.Macros
      # ^ provides `scope_css ~H"..."` macro
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: TemplateCoffeeWeb.Endpoint,
        router: TemplateCoffeeWeb.Router,
        statics: TemplateCoffeeWeb.static_paths()
    end
  end
